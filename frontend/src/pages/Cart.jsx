    ...
    return (
      <div className="py-20 page-container text-center min-h-[60vh] flex flex-col items-center justify-center">
        ...
        >
          ...
          <Link to="/products" id="cart-shop-now-btn" className="btn-primary text-base px-8 py-4">
            Start Shopping 🍫
          </Link>
        </motion.div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-choco border border-choco-100 p-6 sticky top-24">
              ...
              <Link to="/products" className="block text-center text-sm text-choco-600 hover:text-choco-900 mt-4 transition-colors">
                ← Continue Shopping
              </Link>
            </div>
          </div>
